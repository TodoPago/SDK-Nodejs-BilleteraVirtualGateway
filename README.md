...
Este documento explicará como integrar BSA con Decidir utilizando NodeJs.
...
####  Requerimientos
Tanto Todopago como Decidir tienen disponible una SDK de Nodejs que permite utilizar los servicios requeridos. Se pueden obtener desde:
+ Todopago SDK: https://github.com/TodoPago/SDK-Nodejs-BilleteraVirtualGateway
+ Decidir SDK: https://github.com/decidir/sdk-nodejs-v2
...
dataPago = {
                ...
                "payment_mode": "bsa",
                "token": "[TOKEN DE PAGO]",
                "customer": {"id": 123, "email": "email@gmail.com"},
                "payment_method_id": 1,
                "amount": 2000,
                "bin": "450799",
                "currency": "ARS",
